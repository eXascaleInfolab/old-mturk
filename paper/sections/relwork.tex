...
Examples systems based on gamification include the ESP game \cite{vonAhn:2008:DGP:1378704.1378719} where players must agree on tags to use for a picture without the possibility to interact with each other. 
% 
...
An initial work analyzing \amt{} market was done in \cite{mturk}. Our paper extends this work by considering the time dimension and analyzing long term trends and changes.
