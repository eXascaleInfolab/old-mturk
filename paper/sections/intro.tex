...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
	...
	\item A predictive analysis of HIT batch progress using more than 29 different features.
...
In Section \ref{sec:relwork}, we overview recent work on micro-task crowdsourcing specifically focusing on how micro-task crowdsourcing has been used and on how it can be improved.
