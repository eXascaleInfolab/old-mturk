...
Figure \ref{fig:batch_size_pow} shows the distribution of batch sizes per year from 2009 to 2014. We can observe that most of the batches are of size 1, followed by a long tail of larger, but less frequent, batch sizes.
...
\begin{figure}[tb]
	...
	\caption{The yearly distribution of batch sizes.}
