...
% observations
We observe that the `audio' and `transcription' keywords (i.e., blue and red paths from left to right) have substantially increased in frequency over time. They have become being the most popular keywords in the last two years and are paid more than \$1 on average.
